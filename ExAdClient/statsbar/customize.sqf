...
ExAd_SB_ICON_COMPASS = 	"ExAdClient\StatsBar\Icons\compass.paa";	//STRING - Path to compass icon
ExAd_SB_ICON_GRID = 	"ExAdClient\StatsBar\Icons\ExAd_Grid.paa";		//STRING - Path to grid icon
ExAd_SB_ICON_HP = 		"ExAdClient\StatsBar\Icons\health.paa";	//STRING - Path to health icon
ExAd_SB_ICON_HUNGER = 	"ExAdClient\StatsBar\Icons\hunger.paa";	//STRING - Path to hunger icon
ExAd_SB_ICON_KD = 		"ExAdClient\StatsBar\Icons\ExAd_KD.paa";		//STRING - Path to kill death ratio icon
ExAd_SB_ICON_PLAYERS = 	"ExAdClient\StatsBar\Icons\players.paa";	//STRING - Path to players icon
...
ExAd_SB_ICON_TIMER = 	"ExAdClient\StatsBar\Icons\restart.paa";	//STRING - Path to restart icon
ExAd_SB_ICON_Wallet = 	"ExAdClient\StatsBar\Icons\poptab_ca.paa";	//STRING - Path to POP TABS icon
