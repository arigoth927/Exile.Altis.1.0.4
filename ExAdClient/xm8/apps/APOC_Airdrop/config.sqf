...
APOC_AA_UseExileLockerFunds = true;
APOC_AA_DamageOnWhenLanded = true;

APOC_AA_coolDownTime = 300;
...
//Also, presently, these are NON-Persistant vehicles.  Meaning that they will not last over a restart.  Keep that in mind with prices.  Later updates I'll set that up, with pin code entry.
	["Vehicles",
		[
			["Offroad", 		"Exile_Car_Offroad_Guerilla01",		25000, "vehicle", 1000],
			["Fuel Van",	 	"Exile_Car_Van_Fuel_Black",			55000, "vehicle", 1000],
			["Little Bird", 	"Exile_Chopper_Hummingbird_Green", 		45000, "vehicle", 1000],			
			["Strider", 		"Exile_Car_Strider", 				65000, "vehicle", 1000],
			["Ifrit HMG", 		"O_MRAP_02_hmg_F", 					85000, "vehicle", 1000],
			["Hunter HMG", 		"B_MRAP_01_hmg_F", 					95000, "vehicle", 1000]
		]
	],
