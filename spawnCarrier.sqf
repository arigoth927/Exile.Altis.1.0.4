...
//  Spawn Carrier
private _obj = ["Land_Carrier_01_base_F",[22194.21875,5698.311035,0],[],0,"NONE"];
private _vehicle = (_obj select 0) createVehicle (_obj select 1);
_vehicle allowDamage false;
_vehicle setPosWorld [22194.21875,5698.311035,0]; // [x,y,z] or positionWorld
_vehicle setDir 0; // North
